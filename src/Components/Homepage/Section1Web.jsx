      ...
      >
        <Stack spacing={3} sx={{ pr: 6 }}>
          ...
          <Typography variant="body2" display="block">
            ...
            pets that receive personalized care 24/7. <br /> <br /> Our main
            values are centered in empathy, respect, and responsibility for our
            scaly friends and children alike. Your experience will go at your
            own pace, whether you want to go hands-on (or not) is entirely up to
